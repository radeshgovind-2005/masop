...
export function LandingPage() {
  return (
    <Hero10
      title="MASOP"
      description="Browse, create, and edit AI agents, then orchestrate them to run security scans — SAST, secrets, and dependency checks — with findings surfaced in one place."
      images={[
